...
### 🔍 Умный поиск и Мультимедиа
- **Глобальный поиск:** Поиск по установленным приложениям и внешним источникам (торренты, фильмы) с поддержкой голосового ввода.
- **Интеграция с TorrServe:** Автоматическое определение наличия TorrServe, помощь в установке и возможность прямого запуска торрентов из результатов поиска.
- **Стабильность фокуса:** Улучшенная логика навигации D-Pad в поиске (версия 5.0.5), исключающая "потерю" фокуса при пустых списках или обновлении данных.

### 🎥 Заставки (Screensavers)
- **Deep Night Space:** Фирменная анимированная заставка с эффектом полета сквозь звезды, часами в стиле Matrix и погодными данными.
- **Aerial Dream:** Интеграция качественных видео-заставок (Apple TV Style) с поддержкой 4K и кэшированием.
